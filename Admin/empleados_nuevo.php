...
<html>
    ...
    <script>
        function ejecutaAjax()
        {
            ...
            if(nombre == '' || apellidos == '' || correo=='' || pass=='' || rol=='2' || archivo == '0'){
    ...
    <body>
        ...
        <form enctype="multipart/form-data" name="forma01" action="empleados_salva.php" method="post">
            <div class='layout'>
            <div class='box c1'><b align=center>Alta de empleados</b></div>
                <div class=box>Nombre(s) del usuario: <input type="text" name="nombre" id="nombre" required></div>
                <div class=box>Apellido(s) del usuario: <input type="text" name="apellidos" id="apellidos" required></div>
            <div class=box>Correo del usuario: <input type="text" name="correo" id="correo" onblur="fueraFoco();" required></div>
            <div class=box><div id="mensaje1"></div></div>
            <div class=box>Contraseña del usuario: <input type="text" name="pass" id="pass" required></div>
