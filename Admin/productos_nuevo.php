...
<html>
    ...
    <script>
        function ejecutaAjax()
        {
            ...
            if(nombre == '' || costo == '' || codigo=='' || stock=='' || descripcion=='' || archivo == '0'){
    ...
    <body>
        ...
        <form enctype="multipart/form-data" name="forma01" action="productos_salva.php" method="post">
            <div class='layout'>
            <div class='box c1'><b align=center>Alta de productos</b></div>
                <div class=box>Nombre del producto: <input type="text" name="nombre" id="nombre" required></div>
