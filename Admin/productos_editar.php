...
<html>
    ...
    <script>
        function ejecutaAjax()
        {
            ...
            if(nombre == '' || costo == '' || codigo=='' || stock=='' || descripcion==''){
    ...
    <body>
        ...
        <form enctype="multipart/form-data" name="forma01" action="productos_salva.php" method="post">
            <div class='layout'>
            <div class='box c1'><b align=center>Edicion de productos</b></div>
                <div class=box>Nombre del producto: <input value="<?php echo $nombre?>" type="text" name="nombre" id="nombre" required></div>
                <div class=box>Costo: <input value=<?php echo $costo?> type="text" name="costo" id="costo" required></div>
                <div class=box>Código del producto: <input value=<?php echo $codigo?> type="text" name="codigo" id="codigo" onblur="fueraFoco();" required></div>
                <div class=box><div id="mensaje1"></div></div>
                <div class=box>Stock: <input value=<?php echo $stock?> type="text" name="stock" id="stock" required></div>
                <div class=box>Descripción: <input value="<?php echo $descripcion?>" type="text" name="descripcion" id="descripcion" required></div>
        ...
        <?php
        echo "<div class='box b1'><a href=\"productos.php\" class='btn'>Regresar al listado de productos</a></div>"
        ?>
    </body>
