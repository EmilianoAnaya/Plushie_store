...
<html>
    ...
    .caja
    {
        ...
        grid-template-columns: 50px 150px 120px 180px 100px 100px 100px 100px 100px;
    }
...
$filas   = $res->num_rows;
    ...
    echo "<div class='menu'>";
        ...
        echo "<a class='btn b1'>PRODUCTOS</a>";
...
echo "<br><a href=\"productos_nuevo.php\" class='bt s1'>Dar de Alta</a><br><br>"; 
?>
...
<div class="layout">
    <div class="caja">
        ...
        <div class="c1">Descripción</div>
        <div class="c1">Costo</div>
        <div class="c1">Stock</div>
...
while($row = $res->fetch_array())  {  //fetch_array toma fila por fila
    ...
    <div class = "caja" id="reg<?php echo $row["id"]?>">
        ...
        <div class="c2"><?php echo "$codigo" ?></div>
        <div class="c2"><?php echo "$descripcion" ?></div>
        <div class="c2"><?php echo "$costo$" ?></div>
        <div class="c2"><?php echo "$stock" ?></div>
        <div class="c2"><a <?php echo "href=\"productos_perfil.php?id=$id?\""?> class='bt'>Ver Detalle</a></div>
        <div class="c2"><a <?php echo "href=\"productos_editar.php?id=$id\""?> class='bt'>Editar</a></div>
