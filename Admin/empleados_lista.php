...
<style>
    ...
    .caja
    {
        ...
        grid-template-columns: 50px 200px auto 100px 100px 100px 100px;
    }
    ...
    .s1
    {
        ...
        body
        {
            background-image: url("http://drive.google.com/uc?export=view&id=1zCTM9WFdnvCEghp54_doc_FDSUpytom4");
...
<script>
    ...
    function ejecutaAjax(id)
    {
        ...
        if(confirm("¿Estas seguro de borrar al empleado #"+id+"?")==true){
            $.ajax
            ({
...
$filas   = $res->num_rows;
    ...
    echo "<div class='menu'>";
        ...
        echo "<a class='btn b1'>EMPLEADOS</a>";
...
/*echo "Listado de Empleados<br>Total de empleados: $filas<br><br>";*/
echo "<br><a href=\"empleados_nuevo.php\" class='bt s1'>Dar de Alta</a><br><br>"; ?>


<div class="layout">
    <div class="caja">
        <div class="c1">ID</div>
        <div class="c1">Nombre Completo</div>
        <div class="c1">Correo</div>
        <div class="c1">Rol</div>
...
while($row = $res->fetch_array())  {  //fetch_array toma fila por fila
    ...
    <div class = "caja" id="reg<?php echo $row["id"]?>">
        ...
        <div class="c2"><?php echo "$nombre $apellidos"?></div>
        <div class="c2"><?php echo "$correo" ?></div>
        <div class="c2"><?php echo "$etiqueta" ?></div>
        <div class="c2"><a <?php echo "href=\"empleados_perfil.php?id=$id?\""?> class='bt'>Ver Detalle</a></div>
        <div class="c2"><a <?php echo "href=\"empleados_editar.php?id=$id\""?> class='bt'>Editar</a></div>
